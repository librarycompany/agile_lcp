<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xlink marc" version="1.0">
	...
	LIBRARY COMPANY OF PHILADELPHIA modifications
	2017-05-05 - Added 850$q to Accession Number field
    ...
    <xsl:template match="/">
        <xsl:choose>
            <xsl:when test="//marc:collection|//records">
                <modsCollection xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-6.xsd">
                    <xsl:for-each select="//marc:collection/marc:record|//records/marc:record">
                        <mods version="3.6">
    ...
    <xsl:template name="marcRecord">
        ...
        <xsl:for-each select="marc:datafield[@tag='796'][not(marc:subfield[@code='t'])]">
            <xsl:call-template name="createNameFrom796"/>
        </xsl:for-each>

        <xsl:for-each select="marc:datafield[@tag='797'][not(marc:subfield[@code='t'])]">
            <xsl:call-template name="createNameFrom797"/>
        </xsl:for-each>
...
-->
        ...
        <originInfo>
            ...
            <xsl:choose>
                ...
                <xsl:when test="($controlField008-6='e' or $controlField008-6='p' or $controlField008-6='r' or $controlField008-6='s' or $controlField008-6='t') and ($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
                ...
                <xsl:when test="($controlField008-6='e' or $controlField008-6='p' or $controlField008-6='r' or $controlField008-6='s' or $controlField008-6='t') and not($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
                    <xsl:if test="$controlField008-7-10"> <!-- and ($controlField008-7-10 != $dataField260c) -->
                ...
                <xsl:when test="($controlField008-6='c' or $controlField008-6='d' or $controlField008-6='i' or $controlField008-6='k' or $controlField008-6='m' or $controlField008-6='u') and ($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
                ...
                <xsl:when test="($controlField008-6='c' or $controlField008-6='d' or $controlField008-6='i' or $controlField008-6='k' or $controlField008-6='m' or $controlField008-6='u') and not($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
                    <xsl:if test="$controlField008-7-10">
                        <dateIssued encoding="marc" point="start">
                            <xsl:value-of select="$controlField008-7-10"/>
                        </dateIssued>
                ...
                <xsl:when test="$controlField008-6='q'">
                    <xsl:if test="$controlField008-7-10">
                ...
                <xsl:otherwise>
                    <xsl:choose>
                        <xsl:when test="matches($dataField260c, '.*([1-9][0-9]{3}).*-.*([1-9][0-9]{3}).*')">
                            <dateIssued encoding="marc" point="start">
                                <xsl:choose>
                                    <xsl:when test="contains($dataField260c, 'ca.') or contains($dataField260c, 'circa') or contains($dataField260c, 'ca ')">
                                        <xsl:attribute name="qualifier">approximate</xsl:attribute>
                                    </xsl:when>
                                    <xsl:when test="contains($dataField260c, '[') or contains($dataField260c, ']')">
                                        <xsl:attribute name="qualifier">inferred</xsl:attribute>
                                    </xsl:when>
                                    <xsl:when test="contains($dataField260c, '?')">
                                        <xsl:attribute name="qualifier">questionable</xsl:attribute>
                                    </xsl:when>
                                </xsl:choose>
                                <xsl:value-of select="replace($dataField260c, '.*([1-9][0-9]{3}).*-.*([1-9][0-9]{3}).*', '$1')" />
                            </dateIssued>
                            <dateIssued encoding="marc" point="end">
                                <xsl:choose>
                                    <xsl:when test="contains($dataField260c, 'ca.') or contains($dataField260c, 'circa') or contains($dataField260c, 'ca ')">
                                ...
                                <xsl:value-of select="replace($dataField260c, '.*([1-9][0-9]{3}).*-.*([1-9][0-9]{3}).*', '$2')" />
                            </dateIssued>
                        </xsl:when>
                        <xsl:when test="matches($dataField260c, '.*?([1-9][0-9]{3}).*')">
                            <dateIssued encoding="marc">
                                <xsl:choose>
                                    <xsl:when test="contains($dataField260c, 'ca.') or contains($dataField260c, 'circa') or contains($dataField260c, 'ca ')">
                                        <xsl:attribute name="qualifier">approximate</xsl:attribute>
                                ...
                                <xsl:value-of select="replace($dataField260c, '.*?([1-9][0-9]{3}).*', '$1', '')" />
                            </dateIssued>
                        </xsl:when>
                    </xsl:choose>
                </xsl:otherwise>
...
-->
        ...
        <xsl:for-each select="marc:datafield[@tag='850']">
            <identifier type="accession number" displayLabel="Accession number">
                <xsl:call-template name="subfieldSelect">
    ...
    <xsl:template match="marc:datafield" mode="trans880">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$sf06a='796'">
                <xsl:call-template name="createNameFrom796"/>
            </xsl:when>
            <xsl:when test="$sf06a='797'">
                <xsl:call-template name="createNameFrom797"/>
            </xsl:when>
...
-->
    ...
    <xsl:template name="createTitleInfoFrom245">
        <titleInfo>
            ...
            <xsl:choose>
                <xsl:when test="contains($titleChop, ']]')">
                    <nonSort xml:space="preserve"><xsl:value-of select="replace(substring-before($titleChop, ']]'), '\[\[', '')"/> </nonSort>
                    <title>
                        <xsl:value-of select="normalize-space(substring-after($titleChop, ']]'))" />
                    </title>
                </xsl:when>
                <xsl:when test="@ind2&gt;0">
                    <xsl:if test="@tag!='880'">
    ...
    <xsl:template name="createNameFrom700">
        ...
        <xsl:if test="@ind1='3'">
            <name type="family" displayLabel="Contributor">
                <xsl:call-template name="xxx880"/>
                <xsl:call-template name="nameABCDQ"/>
                <xsl:call-template name="affiliation"/>
                <xsl:call-template name="role"/>
    ...
    <xsl:template name="createNameFrom796">
        <xsl:if test="@ind1='1'">
        ...
        <xsl:if test="@ind1='3'">
            <name type="family" displayLabel="Associated name">
                <xsl:call-template name="xxx880"/>
                <xsl:call-template name="nameABCDQ"/>
                <xsl:call-template name="affiliation"/>
                <xsl:call-template name="role"/>
    ...
    <xsl:template name="createNameFrom797">
        <xsl:if test="not(marc:subfield[@code='9'] = 'Imprint:' or marc:subfield[@code='9'] = 'Imprint')">
...
-->
    ...
    <xsl:template name="createLocationFrom852">
        <location>
            <xsl:if test="marc:subfield[@code='a' or @code='b' or @code='c' or @code='e']">
                <physicalLocation>
                    <xsl:variable name="my852">
                        <xsl:call-template name="subfieldSelect">
                            <xsl:with-param name="codes">a</xsl:with-param>
                        </xsl:call-template>
                        <xsl:choose>
                            <xsl:when test="marc:subfield[@code='b'] = 'PRINT' or marc:subfield[@code='b'] = 'Print Dept.'">
                                | Print Department
                            </xsl:when>
                            <xsl:when test="marc:subfield[@code='b'] = 'BOOKS'">
                                | Books &amp; Other Texts
                            </xsl:when>
                            <xsl:when test="marc:subfield[@code='b'] = 'Rare'">
                                | Books &amp; Other Texts | Rare
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:if test="marc:subfield[@code = 'b']">
                                    |
                        ...
                        <xsl:choose>
                            <xsl:when test="marc:subfield[@code='c'] = 'PRINT' or marc:subfield[@code='b'] = 'Print Dept.'"></xsl:when>
                            <xsl:when test="marc:subfield[@code='c'] = 'RARE'">
                                | Rare
                            </xsl:when>
                            <xsl:when test="marc:subfield[@code='c'] = 'STACK'">
                                | Stack
                            </xsl:when>
                            <xsl:when test="marc:subfield[@code='c'] = 'HSP'">
                                | HSP at LCP
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:text> </xsl:text>
                                <xsl:call-template name="subfieldSelect">
                                    <xsl:with-param name="codes">ce</xsl:with-param>
                                </xsl:call-template>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
                    <xsl:value-of select="normalize-space($my852)" />
                    <!--
					<xsl:call-template name="subfieldSelect">
